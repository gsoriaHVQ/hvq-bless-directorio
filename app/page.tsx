    ...
    <DirectorioLayout showBackButton={false}>
      <div className="flex flex-col items-center justify-center h-full w-full text-center">
        ...
        <div className="w-full max-w-6xl bg-white/95 border border-gray-200 rounded-3xl shadow-xl px-8 md:px-14 pt-16 md:pt-20 pb-12 md:pb-14 mb-12">
          ...
          <Image src="http://horizon-html:35480/public/img_directorio/aplicativo_logo.svg" alt="Logo HTQ" width={200} height={200} className="mb-10 mx-auto" />

          {/* Imagen del edificio */}
          <Image
            src="http://horizon-html:35480/public/img_directorio/homeline.png"
            alt="Edificio Médico"
            width={800}
            height={380}
